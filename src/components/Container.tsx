...
const navLinks = [
  ...
  { href: "#videoEditing", text: "Video Editing" },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.annaturner.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.annaturner.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="annaturner" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="annaturner" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Anna Turner</span>
        </Link>
